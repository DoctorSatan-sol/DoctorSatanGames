...
export default function RoulettePrev() {
    return (
        <div className="basis-[24%] min-w-[180px] flex-shrink-0 flex flex-col items-start">
            <Link href="/roulette" className="group block rounded-xl overflow-hidden shadow-lg border-2 border-red-800 bg-black/70 hover:scale-105 transition-all duration-200">
